...
mod no_dsu_no_compress {
    ...
    fn test_basic_insert_delete_query() {
        ...
        let mut t = DNDTree::from_adj(&adj);
    ...
    fn test_mixed_ops_query_heavy() {
        ...
        let mut tree = DNDTree::from_adj(&adj);
...
mod cpp_tests {
    ...
    fn test_dndtree_matches_idtree() {
        ...
        let mut idt = DNDTree::from_adj(&adj_id);
    ...
    fn verify_idtree_topology_sync(cpp: &UniquePtr<ffi::CPPDNDTree>, idt: &DNDTree, n: usize) {
        for i in 0..n {
    ...
    fn test_dndtree_matches_idtree_mtx() {
        ...
        let mut idt = DNDTree::from_adj(&mtx_data.empty_map_usize);
